...
{#if !isEdit}
    <div class="policecomputer__title mt-20 mb-12">{translateText('fractions', 'Список законов')}</div>
    <div class="policecomputer__back">Выберите статью для настройки</div>
{/if}
{#if isEdit}
